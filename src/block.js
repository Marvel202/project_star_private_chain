...
class Block {
    ...
    getData() {
        ...
        return new Promise((resolve, reject)=> {
            ...
            // Decoding the data to retrieve the JSON representation of the object & prased the data
            var parsedData = JSON.parse(hex2ascii(this.body))
